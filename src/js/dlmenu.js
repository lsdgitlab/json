...
//    anchor.setAttribute('href', "https://careers.lsdigital.com/");
//    anchor.innerText = "Careers";
//    anchor.classList.add('careelink');
//    document.querySelector('body').appendChild(anchor); 
//  // console.log(bdy);

//  chckUrl= "https://www.lsdigital.com/digiverse.html"
